...
namespace TestProxy
{
    internal class AEEDefaultyProxyMethodBuilder : IProxyMethodBuilder
    {
        public AEEDefaultyProxyMethodBuilder() : this(new AEEDefaultMethodEmitter()) { }

        public AEEDefaultyProxyMethodBuilder(IMethodBodyEmitter emitter)
        {
            if (emitter == null)
            {
