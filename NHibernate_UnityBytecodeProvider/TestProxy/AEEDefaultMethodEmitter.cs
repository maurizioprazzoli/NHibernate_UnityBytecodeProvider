...
namespace TestProxy
{
    internal class AEEDefaultMethodEmitter : IMethodBodyEmitter
    {
        ...
        static AEEDefaultMethodEmitter()
        {
            getInterceptor = interceptorProperty.GetGetMethod();
        }

        public AEEDefaultMethodEmitter() : this(new AEEDefaultArgumentHandler()) { }

        public AEEDefaultMethodEmitter(IArgumentHandler argumentHandler)
        {
